...
class FW_Option_Type_Form_Builder_Item_Name extends FW_Option_Type_Form_Builder_Item {
	...
	public function get_thumbnails() {
		return array(
			array(
				'html' =>
					'<div class="item-type-icon-title" data-hover-tip="' . __( 'Add a Name Field', 'fw' ) . '">' .
					'<div class="item-type-icon"><img src="' . esc_attr( $this->get_uri( '/static/images/icon.png' ) ) . '" /></div>' .
					'<div class="item-type-title">' . __( 'Name Field', 'fw' ) . '</div>' .
					'</div>'
			)
		);
	}
...
FW_Option_Type_Builder::register_item_type( 'FW_Option_Type_Form_Builder_Item_Name' );
